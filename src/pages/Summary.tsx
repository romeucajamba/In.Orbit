...
export function Summary() {
    ...
    const firstIncompleteGoal = data?.find((goal) => !goal.total);
    ...
    return (
        <section className="py-10 max-w-[480px] px-5 mx-auto flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-3">
                ...
                <div className="flex items-center justify-between text-xs text-zinc-400 bg-red-500 mt-2">
                    <span className="space-x-2 flex">Você completou
                        <span className="text-zinc-100"> {firstIncompleteGoal ? <div>{firstIncompleteGoal.total}</div> : <p>Nenhuma meta pendente</p>} </span> de {''}
